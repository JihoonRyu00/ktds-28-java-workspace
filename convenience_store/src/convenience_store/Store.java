...
//			sectionB.items[sectionIndex].stock = displayCount;
	...
	public static void main(String[] args) {
		...
		gs25.sell("A", 0, 3); // A 진열대의 0번 칸의 상품을 3개 판매
		gs25.sell("B", 1, 2); // B 진열대의 1번 칸의 상품을 2개 판매
	}
